      ...
      <div className="flex flex-col gap-10 w-full max-w-[550px]">
        ...
        <div className="space-y-6">
          ...
          <InputRoot>
            ...
            <InputField
              defaultValue={'http://localhost:3000/invite/123912939129'}
              readOnly
            />
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="relative bg-gray-700 boder border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl">
